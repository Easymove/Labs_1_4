...
namespace Labs_1_4
{
    public partial class Form1 : Form
    {
        ...
        private void CpuInitialization()
        {
            ...
            int init_worktime = (int)worktimeUpDown.Value; 
            _cpuArr.Clear();
            ...
            var cpu1 = new CPU(cpu1Power, init_worktime);
            var cpu2 = new CPU(cpu2Power, init_worktime);
            var cpu3 = new CPU(cpu3Power, init_worktime);
            var cpu4 = new CPU(cpu4Power, init_worktime);
            var cpu5 = new CPU(cpu5Power, init_worktime);
        ...
        private void Method3()
        {
            ...
            int worktime = (int)worktimeUpDown.Value;
